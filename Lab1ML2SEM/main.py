...
distances = np.random.randint(5, 50, size=(n_factories, k_cities))  # транспортные расходы
...
# Умная мутация: корректируем недобор городов
